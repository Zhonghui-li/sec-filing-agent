...
# --- an abstain the model wrote as text instead of calling --------------------------------------
def test_a_well_formed_abstain_written_as_text_is_recognised():
    """Three of the five off-topic cases refuse by emitting the CALL into the message content:
...
def test_prose_that_merely_refuses_is_left_alone():
