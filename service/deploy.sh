...
gcloud run deploy sec-filing-agent \
  ...
  --set-env-vars EMB_MODEL=text-embedding-3-small,GEN_LLM_MODEL=gpt-4o,RERANK=1,DAILY_QUOTA=150,RATE_LIMIT_PER_MIN=6,MAX_INPUT_CHARS=500,LANGFUSE_PUBLIC_KEY="$LANGFUSE_PUBLIC_KEY",LANGFUSE_HOST="$LANGFUSE_HOST",LANGFUSE_TRACING_ENVIRONMENT=community \
